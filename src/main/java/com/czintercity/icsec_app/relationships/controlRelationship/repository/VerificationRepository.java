...
@Repository
/**
 * Spring Data repository for {@link com.czintercity.icsec_app.relationships.controlRelationship.entity.Verification} relationships.
 */
public interface VerificationRepository extends CrudRepository<Synergy, UUID> {
    /** Returns {@code true} if a Verification relationship already exists between the given source and target controls. */
