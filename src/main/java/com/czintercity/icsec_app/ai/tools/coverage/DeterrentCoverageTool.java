...
public class DeterrentCoverageTool extends AgentTool {
    ...
    private static final String SYSTEM_PROMPT =
            "You are a cybersecurity analyst. "
                    ...
                    + "0: The control does not deter the use of a given technique in any way.\n"
                    + "1: The control may make a technique marginally less appealing but ultimately not un-viable\n"
