...
public class DetectiveCoverageTool extends AgentTool {
    ...
    private static final String SYSTEM_PROMPT =
            "You are a cybersecurity analyst. "
                    ...
                    + "0: The control has no direct functional alignment with the technique's mechanism. If the control only provides general 'defense-in-depth' or makes reaching the target harder without detecting the technique itself, assign a 0.\n"
                    + "1: The control is architecturally relevant to the technique but offers no reliable detection. It may only detect the technique if the attacker makes a significant error or uses a highly non-standard implementation.\n"
