...
public class PreventativeCoverageTool extends AgentTool {
    ...
    private static final String TOOL_DESCRIPTION =
            "Evaluates how well a given security control prevents the success of a provided MITRE ATT&CK for ICS technique; "
            + "i.e., how likely a given control is to prevent an attempt to execute a MITRE ATT&CK Technique from succeeding. "
    ...
    private static final String SYSTEM_PROMPT =
            "You are a cybersecurity analyst. "
                    ...
                    + "0: The control has no direct functional alignment with the technique's mechanism. If the control only provides general 'defense-in-depth' or makes reaching the target harder without stopping the technique itself, assign a 0.\n"
                    + "1: The control is architecturally relevant to the technique but offers no reliable prevention. It may only stop the technique if the attacker makes a significant error or uses a highly non-standard implementation.\n"
                    + "2: The control provides partial prevention and is sufficient to prevent the success of the given technique for 25 to 50% of available vectors in a typical OT environment, and is likely to stop an unskilled attacker.\n"
                    + "3: The control provides moderate prevention and is sufficient to prevent the success of the given technique for 50 to 75% of available vectors in a typical OT environment, and is likely to stop a moderately skilled attacker and/or the majority of automated exploitation..\n"
                    + "4: The control provides a high degree of prevention is sufficient to prevent the success of the given technique for 75 to 90% of available vectors in a typical OT environment, and is likely to stop a skilled and determined attacker.\n"
